...
Func IniWriteS($filename, $section, $key, $value)
	...
	If $SecondaryOutputFile <> "" Then
		If $s = "search" Or $s = "attack" Or $s = "troop" Or $s = "MyTroops" Or $s = "MySpells" Or $s = "spells" Or $s = "milkingattack" Or $s = "endbattle" or $s = "collectors" or ($s = "general" And $k = "version") Then
