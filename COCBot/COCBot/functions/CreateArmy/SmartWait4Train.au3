...
Func SmartWait4Train()
	...
	If $aShieldStatus[0] = "none" And BitOR($ichkCloseWaitTrain,$ibtnCloseWaitStop,$ibtnCloseWaitStopRandom,IsWaitforSpellsActive(),IsWaitforHeroesActive()) = 0 Then Return ; skip if not on shield and other options not selected
	;================
