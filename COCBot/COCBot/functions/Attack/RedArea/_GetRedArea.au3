...
Func _GetRedArea($iMode = $REDLINE_IMGLOC)
	...
	If $iMatchMode = $LB And $iAtkAlgorithm[$LB] = 0 And $iChkDeploySettings[$LB] = 5 Then ; Used for DES Side Attack (need to know the side the DES is on)
	...
	ElseIf $iMatchMode = $LB And $iAtkAlgorithm[$LB] = 0 And $iChkDeploySettings[$LB] = 6 Then ; Used for TH Side Attack (need to know the side the TH is on)
