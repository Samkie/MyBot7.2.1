...
Func AttackReport()
	...
	If $numLSpellDrop > 0 Then ;samm0d
		$AtkLogTxt &=  "z" & $numLSpellDrop & StringFormat("%5d",$iDarkLast) & "|"
		$numLSpellDrop = 0
	Else
