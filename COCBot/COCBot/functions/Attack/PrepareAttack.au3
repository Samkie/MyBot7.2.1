	...
	Else
		Switch $pTroopType
			...
			Case  $eLSpell
				Switch $pmatchMode
					Case $DB
						 If $ichkLightSpell[$DB] = 1 Or $ichkSmartZap = 1 Or $ichkUseSamM0dZap = 1 Then Return True
					Case $LB
						 If $ichkLightSpell[$LB] = 1 Or $ichkSmartZap = 1 Or $ichkUseSamM0dZap = 1 Then Return True
					Case $TS
						 If $ichkLightSpell[$TS] = 1 Or $ichkSmartZap = 1 Or $ichkUseSamM0dZap = 1 Then Return True
					Case $MA
						 If $ichkLightSpell[$DB] = 1 Or $ichkSmartZap = 1 Or $ichkUseSamM0dZap = 1 Then Return True
				EndSwitch
			Case  $eHSpell
