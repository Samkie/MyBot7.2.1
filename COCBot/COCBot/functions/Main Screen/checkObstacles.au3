...
Func _checkObstacles() ;Checks if something is in the way for mainscreen
	...
	;=======================================
	If _ColorCheck(_GetPixelColor(160, 380,$bNoCapturePixel), Hex(0xFFFFFF, 6),5) And _ColorCheck(_GetPixelColor(699, 380,$bNoCapturePixel), Hex(0xFFFFFF, 6),5) Then
		AndroidBackButton()
		$MinorObstacle = True
	...
	If _ColorCheck(_GetPixelColor(550, 390,$bNoCapturePixel), Hex(0xFFBB34, 6),5) And _ColorCheck(_GetPixelColor(440, 390,$bNoCapturePixel), Hex(0xFFBB34, 6),5) And _
	_ColorCheck(_GetPixelColor(325, 390,$bNoCapturePixel), Hex(0xFFFFFF, 6),5) And _ColorCheck(_GetPixelColor(300, 375,$bNoCapturePixel), Hex(0xFFFFFF, 6),5) Then
	...
	If _ColorCheck(_GetPixelColor($aButtonVillageCancel[4], $aButtonVillageCancel[5],$bNoCapturePixel), Hex($aButtonVillageCancel[6], 6), $aButtonVillageCancel[7]) And _
		_ColorCheck(_GetPixelColor($aButtonVillageLoad[4], $aButtonVillageLoad[5],$bNoCapturePixel), Hex($aButtonVillageLoad[6], 6), $aButtonVillageLoad[7]) Then
...
;~ 		If _ColorCheck(_GetPixelColor($tempButton[4], $tempButton[5], $bNoCapturePixel), Hex($tempButton[6], 6), Number($tempButton[7])) Then
;~ 			Local $x1, $y1
