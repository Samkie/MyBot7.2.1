Func MyNameOfTroop($iKind, $iPlural = 0)
	...
	EndSwitch
	If $iPlural > 0 And $iKind = $eWitc Then $sTroopname &= "e" ; adding the "e" for "witches"
	If $iPlural > 0 Then $sTroopname &= "s" ; if troop is not $eKing, $eQueen, $eCastle, $eWarden add the plural "s"
	Return $sTroopname
