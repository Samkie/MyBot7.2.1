...
GUICtrlSetData($txtTotalCountSpell2, $iTotalCountSpell)

lblMyTotalCountSpell()

_GUI_Value_STATE("HIDE",$groupListTHLevels)
If $iTownHallLevel >= 4 And $iTownHallLevel <= 11 Then
	GUICtrlSetState(Eval("THLevels" & StringFormat("%02i",$iTownHallLevel)), $GUI_SHOW)
EndIf