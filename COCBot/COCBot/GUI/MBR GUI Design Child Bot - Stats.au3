...
;~ ;==================samm0d samm0dzap=============================================
;~ GUICtrlCreateIcon($pIconLib, $eIcnDark, $x-20, $y+285, 20, 20)
;~ $lblSmartZap2 = GUICtrlCreateLabel("0", $x+5, $y+285, 80, 30, $SS_LEFT)
;~ 	GUICtrlSetFont(-1, 14, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
;~ 	GUICtrlSetColor(-1, 0x279B61)
;~ 	$txtTip = "Number of dark elixir zapped during the attack with lightning."
;~ 	_GUICtrlSetTip(-1, $txtTip)

;~ GUICtrlCreateIcon($pIconLib, $eIcnLightSpell, $x + 100, $y + 285, 20, 20)
;~ $lblLightningUsed2 = GUICtrlCreateLabel("0", $x + 125, $y + 285, 50, 30, $SS_LEFT)
;~ 	GUICtrlSetFont(-1, 14, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
;~ 	GUICtrlSetColor(-1, 0x279B61)
...
$hGUI_STATS_TAB_ITEM3 = GUICtrlCreateTabItem(GetTranslated(600,40,"Attacks"))
	...
	$y -= 10
		...
		GUICtrlCreateLabel(GetTranslated(632,74, -1) & ":", $x + 13, $y + 2, -1, 17)
		_GUICtrlSetTip(-1, $txtTip)
		$lblSmartZapStats = GUICtrlCreateLabel("0", $x + 115, $y + 2, 70, 17, $SS_RIGHT)
		GUICtrlSetFont(-1, 9, $FW_BOLD, Default, "Arial", $CLEARTYPE_QUALITY)
		GUICtrlSetColor(-1, $COLOR_BLACK)
		_GUICtrlSetTip(-1, $txtTip)
	$y += 20
		...
		_GUICtrlSetTip(-1, $txtTip)
		$lblLightningUsedStats = GUICtrlCreateLabel("0", $x + 115, $y + 2, 70, 17, $SS_RIGHT)
		GUICtrlSetFont(-1, 9, $FW_BOLD, Default, "Arial", $CLEARTYPE_QUALITY)
		GUICtrlSetColor(-1, $COLOR_BLACK)
		_GUICtrlSetTip(-1, $txtTip)
	$y += 20
		...
		GUICtrlCreateLabel(GetTranslated(632,123, "Used") & ":", $x + 13, $y + 2, -1, 17)
		_GUICtrlSetTip(-1, $txtTip)
		$lblEarthQuakeUsedStats = GUICtrlCreateLabel("0", $x + 115, $y + 2, 70, 17, $SS_RIGHT)
		GUICtrlSetFont(-1, 9, $FW_BOLD, Default, "Arial", $CLEARTYPE_QUALITY)
		GUICtrlSetColor(-1, $COLOR_BLACK)
		_GUICtrlSetTip(-1, $txtTip)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
...
GUICtrlCreateTabItem("")
	...
	$lblProfileName = GUICtrlCreateLabel("Profile", $x+9, $y, 190, 17, $SS_CENTER)
	$txtTip = GetTranslated(671,26, "Better result is pause bot before view stats.")
	_GUICtrlSetTip(-1, $txtTip)
	$arrowleft2 = GUICtrlCreatePic(@ScriptDir & "\Images\triangle_left.bmp", $x, $y+1, 8, 14)
	$txtTip = GetTranslated(671,25, "Switch between profile stats")
	_GUICtrlSetTip(-1, $txtTip)
