...
Local $x = 25, $y = 45
	;===== samm0d
	$chkDebugMyOcr = GUICtrlCreateCheckbox(GetTranslated(671, 23, "GetMyOcr Debug"),$x+140, $y)
		_GUICtrlSetTip(-1, "Enable setlog for debug getMyOcr function")
		GUICtrlSetState(-1, $GUI_UNCHECKED)
		GUICtrlSetOnEvent(-1, "chkDebugMyOcr")

	$chkDebugSamM0d = GUICtrlCreateCheckbox(GetTranslated(671, 24, "SamM0d Debug"),$x+140, $y+20)
