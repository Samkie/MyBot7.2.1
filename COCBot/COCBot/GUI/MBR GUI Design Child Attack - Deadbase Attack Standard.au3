...
;	$x -= 15
	...
	$y += 25
		...
		$cmbDeployDB = GUICtrlCreateCombo("", $x + 55, $y, 120, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			;samm0d
			GUICtrlSetData(-1, GetTranslated(608,8, "one side") & "|" & GetTranslated(608,9, "two sides") & "|" & GetTranslated(608,10, "three sides") & "|" & GetTranslated(608,11,"all sides equally") & "|" & GetTranslated(671,42,"Multi Finger") & "|" & GetTranslated(671,104,"Classic Four Finger"), GetTranslated(608,11,"all sides equally"))
