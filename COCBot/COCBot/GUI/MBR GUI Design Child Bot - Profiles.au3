...
Local $x = 25, $y = 45
	$grpProfiles = GUICtrlCreateGroup(GetTranslated(637,1, "Switch Profiles"), $x - 20, $y - 20, 438, 60)
		;$y -= 5
		$x -= 5
		...
		; samm0d
		$btnMakeSwitchADBFolder = GUICtrlCreateButton(GetTranslated(671, 36, "Get shared_prefs"), $x + 230, $y, 100, 24)
			GUICtrlSetOnEvent(-1, "btnMakeSwitchADBFolder")
			_GUICtrlSetTip(-1, GetTranslated(671,37, "Copy Village save files from Emulator to current profile. Make village name image from profile."))

		$chkUseADBLoadVillage = GUICtrlCreateCheckbox(GetTranslated(671, 38, "Use replace shared_prefs"), $x + 340, $y-7, 80, 40,$BS_MULTILINE)
			GUICtrlSetOnEvent(-1, "chkEnableAcc")
			_GUICtrlSetTip(-1, GetTranslated(671,39, "Use replace shared_prefs method to load account."))
